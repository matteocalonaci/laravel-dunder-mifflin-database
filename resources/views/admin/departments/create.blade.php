...
<div class="background-image">
    <div class="container mt-5">
        <h1 class="text-white text-center mb-4">Crea Nuovo Dipartimento</h1>
        ...
        <form action="{{ route('admin.departments.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="ID_Office" name="ID_Office" required>
            </div>
            ...
            <button type="submit" class="btn btn-success w-100 mt-3">Crea Dipartimento</button>
